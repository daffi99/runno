 ...
 */
export function formatPace(secondsPerKm, unit = 'metric', includeSuffix = true) {
 ...
 */
export function formatDistance(km, unit = 'metric', showUnit = true) {
 ...
 */
export function formatSpeed(kmh, unit = 'metric', showUnit = true) {
 ...
 * Format date nicely
 */
export function formatDate(dateStr, formatType = 'short') {
    if (!dateStr)
        return 'Unknown Date';
    try {
 ...
 */
export function calculatePaceSeconds(distanceKm, durationSec) {
 ...
 */
export function calculateSpeedKmh(distanceKm, durationSec) {
    if (distanceKm <= 0 || durationSec <= 0)
        return null;
 ...
 */
export function getDateForDayOfWeek(dayOfWeek, baseDate = new Date()) {
 ...
 */
export function formatFullWorkoutDate(date) {
    const d = typeof date === 'string' ? new Date(date) : date;
    if (isNaN(d.getTime()))
        return '';
    return d.toLocaleDateString('id-ID', {
 ...
 */
export function formatWeekRange(baseDate = new Date()) {
