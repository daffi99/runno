...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary:
      'bg-white hover:bg-neutral-50 text-neutral-800 border border-neutral-200 shadow-soft-sm',
    outline:
      'bg-transparent hover:bg-neutral-100 text-[#FF5500] border border-[#FF5500]',
    ghost:
